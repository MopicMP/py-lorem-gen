...
> Py generate lorem ipsum placeholder text

[![PyPI version](https://badge.fury.io/py/py-lorem-gen.svg)](https://pypi.org/project/py-lorem-gen/)
...
```bash
pip install py-lorem-gen
```

## Quick Start

```python
from py_lorem_gen import gen
...
from py_lorem_gen import batch
